...
-- ארגומנטים: p_client_id text, p_key text, p_write boolean, p_value jsonb, p_source text, OUT out_current jsonb, OUT out_ok boolean
...
begin
  ...
  case p_key
    ...
    when 'spouseNoIncomeEligible' then

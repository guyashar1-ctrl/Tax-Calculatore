...
export const ACCOUNTANT_NOTIFICATIONS: AccountantNotificationDef[] = [
  ...
  {
    // ‼ רשת הביטחון של השליחה האוטומטית (D1). מייל הייצוג יוצא מהשרת ברגע
    // אישור ההצעה; אם הוא נכשל, ההצעה נשארת בלי representation_sent_at.
    // ההתראה הזאת היא הדרך של גיא לדעת — במקום לגלות מהלקוח.
    // ‼ החליפה את מנגנון 24 השעות, שעד היום שלח מייל **ללקוח** מתוך הדפדפן
    // של גיא בכניסה למערכת. עכשיו אף מייל ללקוח אינו יוצא מאותו מנגנון.
    kind: 'representation_link_missing',
    label: 'קישור הייצוג לא יצא ללקוח',
    hint: 'עברו 24 שעות מאישור ההצעה והמייל עם קישור הייצוג עדיין לא נשלח — בדרך כלל בגלל כשל שליחה. אפשר לשלוח שוב ממסך בקשת הייצוג.',
    group: 'תהליך הקליטה',
    defaultOn: true,
  },
  {

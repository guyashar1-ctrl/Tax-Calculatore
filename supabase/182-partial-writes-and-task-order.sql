-- ═══════════════════════════════════════════════════════════════════════════
--  182 — כתיבה חלקית מהדפדפן: כרטיס לקוח, סדר משימות, ותוקף הצעות
--  (מספור מקורי: 167. הוזז ל-182 כי סשן מקביל השתמש במספר 167 משלו —
--   167-request-prerequisites-recipient.sql, שכבר הוחל בפרודקשן. שני
--   הקבצים אינם נוגעים באותן פונקציות; אין תלות סדר ביניהם.)
-- ═══════════════════════════════════════════════════════════════════════════

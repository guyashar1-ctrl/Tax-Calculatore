...
export default defineConfig({
  ...
  server: {
    watch: {
      ...
      // ושניהם צודקים:
      //   · תיקיות עבודה מקבילות (.claude/worktrees) הן ריפו נפרד; אין שום
      //     סיבה שהשרת הראשי יצפה בהן.
      //   · worker/ הוא תהליך שרץ על מחשב המשרד, לא חלק מאפליקציית הדפדפן,
      //     ומחזיק תיקיות ריצה משלו.
      // בשני המקרים הצופה של vite ניסה לפתוח קובץ Cookies של פרופיל Chrome
      // חי, קרס ב-EBUSY והפיל את שרת הפיתוח כולו. קרה בפועל, פעמיים.
      ignored: ['**/.claude/worktrees/**', '**/worker/**'],
    },
  },
})

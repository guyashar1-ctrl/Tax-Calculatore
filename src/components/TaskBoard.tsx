...
export default function TaskBoard({
  ...
  return (
    <div className="tasks-page">
      {/* ‼ הקליטות יושבות כאן ולא ב"על השולחן שלי" מסיבה אחת: המסך ההוא אינו
          נגיש מהניווט (navTabs = משימות · לקוחות · הצעות), ומקטע שנקבר שם לא
          יתגלה אף פעם. הן מופרדות מרשימת המשימות ואינן מעורבבות בה — הכפילות
          של "להשלים ייצוג" ירדה במיגרציה 45. ריק ⇒ לא מוצג כלום. */}

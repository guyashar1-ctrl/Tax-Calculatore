...
// ‼ מבוטל. הרכיב הזה היה דף סטטוס נפרד ליישור הקו, ו-V6 ביטל אותו: הבית
// היחיד של המצב מול הרשויות הוא תיק המס. הוא אינו מורכב באפליקציה ונשאר
// למסך הבדיקה בלבד. אין להחיות אותו ואין להסתמך על אב-הטיפוס שלו.
//

      ...
      {stage === 'quoted' && liveQuotation && !liveQuotation.approvedAt && (
        <div className="cw-section">
          ...
          <ol className="jt-consequences">
            ...
            {/* ‼ מיגרציה 135 - בקשה שהוכנה עכשיו מוחזקת עד האישור. בלי השורה
                הזאת המקטע קורא כאילו הרשימה נבנית רק אחר כך, והרו"ח לא מבין
                מה קרה לבקשות שכבר הוסיף. */}
            <li>הבקשות שהכנת בינתיים נפתחות ללקוח בדף האישי - כפי שהן.</li>

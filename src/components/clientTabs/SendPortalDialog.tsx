...
// ‼ הכרעת "הכפתור שמסיים הוא הכפתור ששולח" (2026-08-09 המוקדם) **בוטלה**
// בהכרעת D4 (docs/EMAIL-POLICY.md §9): פרסום דף הלקוח ושליחת המייל הם שתי
// החלטות נפרדות — מפרסמים, ומיד נשאלת השאלה "לשלוח מייל עם הקישור?".
// ההתנהגות כאן (beforeSend מפרסם בתוך לחיצת השליחה) נשארת זמנית עד שלב
// "פס הפרסום" של תוכנית מרכז התיק, שמחליף את הצימוד הזה. לא לשחזר אותו.

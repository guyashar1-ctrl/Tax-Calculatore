    ...
    <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '.5rem' }}>
      <span
        ...
        style={{
          ...
          padding: '.2rem .65rem', borderRadius: 999, fontSize: '12px', fontWeight: 600,
  ...
  return (
    <div style={{ background: 'var(--card)', border: '1px solid var(--gray-200)', borderRadius: 12, padding: '1rem 1.15rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '.5rem', marginBottom: '.6rem' }}>
        <div>
          <span style={{ fontSize: '15px', fontWeight: 600 }}>עדכניות הנתונים</span>
          <span style={{ fontSize: '13px', color: 'var(--gray-500)', marginRight: '.5rem' }}>
        ...
        <button
          ...
          style={{
            padding: '.35rem .8rem', borderRadius: 8, fontFamily: 'inherit', fontSize: '13px', fontWeight: 600,
          ...
          {DATASETS.map((ds: DatasetFreshness) => {
            ...
            return (
              <tr key={ds.id} style={{ borderBottom: '1px solid var(--gray-100)' }}>
                ...
                <td style={{ padding: '.4rem .3rem', color: 'var(--gray-500)', fontSize: '12px' }}>{ds.covers}</td>
      ...
      <div style={{ fontSize: '12px', color: 'var(--gray-500)', marginTop: '.55rem', lineHeight: 1.55 }}>
        {allFresh
